...
This is one part of the very little useful PHP I have written - I normally develop in Ruby. Because of this, I wouldn't be at all surprised if there are parts of this code that are abolutely horrible/downright wrong. If you are a more experienced developer than me, and these parts disgust you, please either fork and pull request back to me, or lodge an issue.

Installation

Easy way for people who just want to use it: Download the tarball, extract and rename folder to job_import (it goes in your site's modules folder).
Harder way for people who want to contribute: Fork and/or Clone the repository: git clone https://github.com/joshmcarthur/drupal_job_import.git job_import
Usage
...
Many thanks to Neal Andrews and Associates, the client for which this module was constructed.
